...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/minesweeper-API?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/minesweeper-API/badge)](http://codestats-url/organizations/your-organization/projects/minesweeper-API/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/minesweeper-API.git`
- Go to the project root by running `cd minesweeper-API`
...
```bash
  ...
  CREATE ROLE "minesweeper-API" LOGIN CREATEDB PASSWORD 'minesweeper-API';
```
